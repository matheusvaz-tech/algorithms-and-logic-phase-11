...
if (average >= 7) {
  ...
  alert(
    `Infelizmente, você foi reprovado direto, ${student}. Sua média foi ${average}.`
  );
} else {
  alert(
    `Infelizmente você não passou direto, ${student}. Sua média foi ${average}, mas com esforço e dedicação você se sairá bem na prova de recuperação.`
  );
}
